  ...
  const mockMembers = [
    {
      ...
      filmography: {
        ...
        "Assistante Casting Rôles (Adultes/Enfants)": "Les vacances de Ducobu (2011), La guerre des boutons (2011), Sapiens Costelle, Groom, La guerre des Lulus (2023), Stark First Target, Le 3ème jour",
