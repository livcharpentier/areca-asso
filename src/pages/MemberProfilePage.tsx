...
const memberData: { [key: string]: any } = {
  "liv-charpentier": {
    ...
    filmography: {
      "Responsable des enfants": "Radin (2016), Le petit Spirou (2017), Rémi sans famille (2018), Parents d'élèves (2020), Le trésor du Petit Nicolas (2021), Abandon (2026), Histoire parallèle (2025), Les enfants de la résistance (2025), Karma (2026), Robin (2026 — série TF1), Les Disparus des Argonnes (2026 — téléfilm), Les Enfants de la Résistance : L'Escalade (2026)",
