              ...
              <div className="space-y-3 text-sm">
                <div className="space-y-2">
                  <div className="flex justify-between border-b border-slate-700 pb-2">
                    <span className="text-muted-foreground">(pour mémoire) Rôle</span>
                    <span className="font-bold text-cyan-300">418,25 €</span>
                  </div>
                  <div className="flex justify-between border-b border-slate-700 pb-2">
                    <span className="text-muted-foreground">Salaire figurants</span>
                  ...
                  <div className="flex justify-between border-b border-slate-700 pb-2">
                    <span className="text-muted-foreground">Figuration costumes spéciaux</span>
                    <span className="font-bold text-cyan-300">Uniforme +70€ / Smoking-Robe +95€</span>
                  </div>
                  <div className="flex justify-between border-b border-slate-700 pb-2">
                    <span className="text-muted-foreground">Indemnité essayage</span>
                  ...
                  <div className="flex justify-between border-b border-slate-700 pb-2">
                    <span className="text-muted-foreground">Silhouette parlante</span>
                ...
                <div className="bg-cyan-800/20 p-2 rounded text-xs">
                  ...
                  <p className="text-muted-foreground">5 jours (40h) : 501,60 € | 6 jours (48h) : 623,20 €</p>
                </div>

                <div className="bg-cyan-800/20 p-2 rounded text-xs">
                  <p className="font-semibold text-cyan-200 mb-1">⏰ Majorations heures supplémentaires</p>
                  <p className="text-muted-foreground">+25% les 9ème et 10ème heures</p>
                  <p className="text-muted-foreground">+50% les 11ème et 12ème heures</p>
                </div>

                <div className="bg-cyan-800/20 p-2 rounded text-xs">
                  <p className="font-semibold text-cyan-200 mb-1">🌙 Heures de nuit</p>
                  <p className="text-muted-foreground text-xs">En cinéma - du 1er/04 au 30/09 : 22h/6h et du 1er/10 au 31/03 : 20h/6h sauf studio 21h/6h</p>
                  <p className="text-muted-foreground text-xs">En USPA - du 21 Déc au 20 Mars : entre 20h et 6h le reste de l'année entre 22h et 7h</p>
                  <p className="text-muted-foreground">Les 8 premières heures +50%, à partir de la 9ème heure +100%</p>
                </div>

                <div className="bg-cyan-800/20 p-2 rounded text-xs">
                  <p className="font-semibold text-cyan-200 mb-1">🚌 Indemnités de transport en commun</p>
                  <p className="text-muted-foreground">Accord préalable de la production</p>
                </div>
              </div>
            </div>
            ...
            <div className="bg-slate-900/60 p-4 rounded-lg border border-cyan-400/20">
              ...
              <div className="space-y-3 text-sm">
                <div className="space-y-2">
                  ...
                  <div className="flex justify-between border-b border-slate-700 pb-2">
                    <span className="text-muted-foreground">Majoration silhouette : muette et jusqu'à 2 répliques</span>
                ...
                <div className="bg-blue-800/20 p-2 rounded text-xs">
                  <p className="font-semibold text-foreground mb-1">📅 Engagement figurant à la semaine</p>
                  <p className="text-muted-foreground">4,5 x salaire journalier (ne peut pas être inférieur au smic)</p>
                </div>

                <div className="bg-blue-800/20 p-2 rounded text-xs">
                  <p className="font-semibold text-foreground mb-1">⏰ Majorations heures supplémentaires</p>
                  <p className="text-muted-foreground">+25% les 9ème, 10ème, 11ème heures</p>
                  <p className="text-muted-foreground">+50% la 12ème heure</p>
                </div>

                <div className="bg-blue-800/20 p-2 rounded text-xs">
                  <p className="font-semibold text-foreground mb-1">🌙 Heures de nuit</p>
                  <p className="text-muted-foreground">+25% par heure</p>
                </div>

                <div className="bg-blue-800/20 p-2 rounded text-xs">
                  <p className="font-semibold text-foreground mb-1">🚌 Indemnités de transport en commun</p>
                  <p className="text-muted-foreground">50% des frais réels engagés</p>
                </div>

                <div className="bg-blue-800/20 p-2 rounded text-xs">
                  <p className="font-semibold text-foreground mb-1">📝 Note</p>
                  <p className="text-muted-foreground text-xs">Cumul des majorations limité à 200%, sauf 1er mai.</p>
                </div>
              </div>
            </div>
          </div>
